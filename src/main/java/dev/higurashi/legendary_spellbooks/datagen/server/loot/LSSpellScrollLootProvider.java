...
public class LSSpellScrollLootProvider extends GlobalLootModifierProvider {
    public LSSpellScrollLootProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> provider) {
        super(output, provider, LegendarySpellbooks.MOD_ID);
    }
    ...
    protected void start() {
        add("cloud_golem_scrolls", new SpellScrollLootModifier(
                ...
                List.of(
                        new SpellEntry(LSSpellRegistry.CLOUD_RAIL_SPELL.get().getSpellResource(), 4, 10, 10),
                        new SpellEntry(LSSpellRegistry.CLOUD_RING_SPELL.get().getSpellResource(), 1, 4, 10),
                        new SpellEntry(LSSpellRegistry.NIMBUS_ARRAY_SPELL.get().getSpellResource(), 1, 6, 10),
                        new SpellEntry(LSSpellRegistry.TRIPLE_NIMBUS_ARRAY_SPELL.get().getSpellResource(), 1, 4, 12),
                        new SpellEntry(LSSpellRegistry.TORNADO_SPELL.get().getSpellResource(), 3, 10, 6),
                        new SpellEntry(LSSpellRegistry.QUAD_TORNADO_SPELL.get().getSpellResource(), 1, 4, 11),
                        new SpellEntry(LSSpellRegistry.ENERGY_BEAM_SPELL.get().getSpellResource(), 1, 3, 8),
                        new SpellEntry(LSSpellRegistry.THUNDER_FANBURST_SPELL.get().getSpellResource(), 3, 10, 10),
                        new SpellEntry(LSSpellRegistry.CUMULO_CHARGE_SPELL.get().getSpellResource(), 1, 3, 12)
                ),
                1.0f,
                1,
                3,
        ...
        add("obliterator_scrolls", new SpellScrollLootModifier(
                ...
                List.of(
                        new SpellEntry(LSSpellRegistry.ANNIHILATION_BEAM_SPELL.get().getSpellResource(), 1, 3, 10),
                        new SpellEntry(LSSpellRegistry.ANNIHILATION_BOMB_SPELL.get().getSpellResource(), 1, 4, 14),
                        new SpellEntry(LSSpellRegistry.ANNIHILATION_SHOCKWAVE_SPELL.get().getSpellResource(), 1, 5, 18),
                        new SpellEntry(LSSpellRegistry.SUMMON_FLAMEBORN_KNIGHTS_SPELL.get().getSpellResource(), 1, 4, 18),
                        new SpellEntry(LSSpellRegistry.ANNIHILATION_RESONANCE_SPELL.get().getSpellResource(), 1, 4, 14)
                ),
                1.0f,
                1,
                2,
        ...
        add("annihilation_pursuer_scrolls", new SpellScrollLootModifier(
                ...
                List.of(
                        new SpellEntry(LSSpellRegistry.RELEASE_RIFTWALKER_PREDATOR_SPELL.get().getSpellResource(), 1, 3, 10)
                ),
                0.5f,
                1,
                1,
        ...
        add("frostbitten_golem_scrolls", new SpellScrollLootModifier(
                ...
                List.of(
                        new SpellEntry(LSSpellRegistry.GLACIER_ERUPTION_SPELL.get().getSpellResource(), 2, 7, 10),
                        new SpellEntry(LSSpellRegistry.GLACIER_RINGBURST_SPELL.get().getSpellResource(), 1, 5, 10)
                ),
                0.8f,
                1,
                1,
        ...
        add("possessed_paladin_scrolls", new SpellScrollLootModifier(
                ...
                List.of(
                        new SpellEntry(LSSpellRegistry.COLLAPSED_KINGDOMS_LEGION_SPELL.get().getSpellResource(), 1, 3, 10),
                        new SpellEntry(LSSpellRegistry.POSSESSED_SOUL_BLADE_SPELL.get().getSpellResource(), 1, 3, 10),
                        new SpellEntry(LSSpellRegistry.POSSESSED_WING_SPELL.get().getSpellResource(), 1, 2, 10),
                        new SpellEntry(LSSpellRegistry.HEMATITE_TRISHULA_SPELL.get().getSpellResource(), 1, 3, 10)
                ),
                1.0f,
                1,
                3,
        ...
        add("ancient_guardian_scrolls", new SpellScrollLootModifier(
                ...
                List.of(
                        new SpellEntry(LSSpellRegistry.AMBUSH_THORNS_SPELL.get().getSpellResource(), 3, 10, 10)
                ),
                0.5f,
                1,
                1,
        ...
        add("lava_eater_scrolls", new SpellScrollLootModifier(
                ...
                List.of(
                        new SpellEntry(LSSpellRegistry.FLAME_EATER_SPELL.get().getSpellResource(), 3, 6, 10),
                        new SpellEntry(LSSpellRegistry.FLAME_SECTOR_SPELL.get().getSpellResource(), 1, 4, 18)
                ),
                1.0f,
                1,
                2,
        ...
        add("overglown_colosus_scrolls", new SpellScrollLootModifier(
                ...
                List.of(
                        new SpellEntry(LSSpellRegistry.OVERGROWN_SHOCKWAVE_SPELL.get().getSpellResource(), 1, 4, 10)
                ),
                1.0f,
                1,
                2,
        ...
        add("skeletosaurus_scrolls", new SpellScrollLootModifier(
                ...
                List.of(
                        new SpellEntry(LSSpellRegistry.FOSSILIZED_FURY_SPELL.get().getSpellResource(), 1, 6, 10)
                ),
                1.0f,
                1,
                2,
        ...
        add("dune_sentinel_scrolls", new SpellScrollLootModifier(
                ...
                List.of(
                        new SpellEntry(LSSpellRegistry.SENTINEL_SATURATION_SPELL.get().getSpellResource(), 1, 2, 10)
                ),
                0.5f,
                1,
                1,
