    ...
    public static class Generator implements AdvancementGenerator {
        ...
        public void generate(HolderLookup.@NotNull Provider provider, @NotNull Consumer<Advancement> saver, @NotNull ExistingFileHelper helper) {
            ...
            Advancement oblivionmancerArmorAdvancement = Advancement.Builder.advancement()
                    .parent(root)
                    .display(LSItemRegistry.STORMMANCER_HOOD.get(), Component.translatable("advancement.legendary_spellbooks.stormmancer_armor.title"), Component.translatable("advancement.legendary_spellbooks.stormmancer_armor.description"), null, FrameType.CHALLENGE, true, true, false)
