...
public class LSCreativeTabRegistry {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> LS_EQUIPMENTS_TAB =
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> LS_SCROLLS_TAB =
